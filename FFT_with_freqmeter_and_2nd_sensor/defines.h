...
// new Sensor
#define DZeroOffset (1.565)
#define EZeroOffset (DZeroOffset)
#define FZeroOffset (DZeroOffset)

#define DSensetivity (0.2/9.8)
#define ESensetivity (DSensetivity)
#define FSensetivity (DSensetivity)
...
#define ADA_BASE_FREQ_C 3.525e5
