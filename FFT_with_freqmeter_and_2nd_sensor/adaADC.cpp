...
void AdaADC::openDevice(UCHAR NumberDevice)
{
	...
	UCHAR DataPhysCh[6] = {0x64, 0x65, 0x66, 0x67, 0x68, 0x69}; // (X0,X1 усиление-1,однопроводный)
	NumbPhysCh = 8; // число каналов
	Fdisc = 2.5e4*NumbPhysCh; // частота дискретизации
...
{
	return ADA_BASE_FREQ_C/ADA_BASE_FREQ*Fdisc;
}
